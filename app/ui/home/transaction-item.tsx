...
Time: ${formatTime(t.createdAt)}`
  ...
  return (
    <>
      <div
        className={`rounded-medium bg-content1 h-auto w-full px-4 py-2 text-left md:px-6 md:py-4 ${isBlinkTransaction && 'animate-blink-light-once dark:animate-blink-dark-once'}`}
      >
